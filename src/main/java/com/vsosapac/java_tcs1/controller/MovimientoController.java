package com.vsosapac.java_tcs1.controller;
...
import com.vsosapac.java_tcs1.service.IMovimientoService;
...
public class MovimientoController {
    ...
    @GetMapping("/{Cuentaid}")
    public List<Movimiento> getByCuenta(@PathVariable int Cuentaid){
        return iMovimientoService.FindByCuenta(Cuentaid);
    }
}
